...
class Student{
	...
	public function insertStudent($name, $roll){
		...
		if(empty($name) || empty($roll)){
			...
			if($stu_insert){
				$msg = "<div class='alert alert-success'><strong>Success!</strong> Student data is inserted successfully !!</div>";
				return $msg;
			}
			else{
				$msg = "<div class='alert alert-danger'><strong>Error!</strong> Student is not inserted !!</div>";
				return $msg;
			}
		}
	}
	...
	public function updateAttendance($dt, $attend){
		...
		if($data_update){
			$msg = "<div class='alert alert-success'><strong>Success!</strong> Student data is updated successfully !!</div>";
			return $msg;
		} else{
			$msg = "<div class='alert alert-danger'><strong>Error!</strong> Student data is not updated !!</div>";
			return $msg;
		}
	}
